...
<?php 
	...
	if (! is_null($student1->getExaminationNumber()))	{
?>
	<!--DIM Section Begin-->
	<div class="ui-sys-printable-section">
		<div class="ui-sys-printable-section-dimension">
			<span class="ui-sys-printable-section-label">Examination Number</span>
			<span class="ui-sys-printable-section-data"><?= $student1->getExaminationNumber() ?></span>
		</div>
	</div>
	<!--DIM Section Ends-->
<?php
...
<?php
	...
	if (! is_null($student1->getListOfAdmissionBatches()))	{
?>
	<!--DIM Section Begin-->
	<div class="ui-sys-printable-section">
		<div class="ui-sys-printable-section-dimension">
			<span class="ui-sys-printable-section-label">Already Admission Batches </span>
			<span class="ui-sys-printable-section-data">
<?php 
		$list1 = $student1->getListOfAdmissionBatches();
		$listString = "";
...
<?php
	...
	if (! is_null($student1->getCurrentBatch()))	{
?>
	<!--DIM Section Begin-->
	<div class="ui-sys-printable-section">
		<div class="ui-sys-printable-section-dimension">
			<span class="ui-sys-printable-section-label">Current Batch</span>
			<span class="ui-sys-printable-section-data"><?= $student1->getCurrentBatch()->getAccademicYear() ?></span>
		</div>
	</div>
	<!--DIM Section Ends-->
<?php 
...
<?php
	...
	$displayList1->add($intent1);
	$intent1 = new Intent("Ztong");
	$intent1->putExtra("labelCaption", "Index Number");$intent1->putExtra("tagName", "indexNumber");
	$intent1->putExtra("className", "None"); $intent1->putExtra("dataType", "text");
	$displayList1->add($intent1);
	$intent1 = new Intent("Ztong");
