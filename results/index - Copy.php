...
<?php 
	/*Begin Group Closing Results*/if ($page == "manageresultsgroup_edit" && isset($_REQUEST['report']) && isset($_REQUEST['rndx']) && isset($_REQUEST['service_compile']) && isset($_REQUEST['id']) && Authorize::isAllowable($config, "manageresultsgroup_edit", "normal", "setlog", "-1", "-1"))	{
		$conn = mysql_connect($hostname, $user, $pass) or die("Could not connect to a database services");
...
?>
		<div class="ui-state-highlight">
			It seems you do not have any results, however you can add a New One by clicking the <b>ADD NEW</b> button below
		</div>
<?php
	}
?>
				...
				<div class="ui-sys-inline-controls-right">
					<a href="<?= $thispage ?>?page=manageresultsgroup_add" title="Add A New Results Group" class="ui-sys-icon-80-by-16 icon-add-new"></a>
				</div>
			</div>
...
<?php
		...
		try {
			...
			//Setting Parametes 
			$object1->putData('lineHeight1', Object::$generalProfileHeader);
			$object1->putData('lineHeight2', $profile1->getProfileName());
